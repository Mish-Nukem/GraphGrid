export default class Versions {
    ...
    versionRows = [
        ...
        {
            Id: 10, Version: '1.0.10', App: 'React Grid',
            Description: `Исправления главного меню (убрано залипание)`,
            Date: '11/11/2025'
        },
        {
            Id: 11, Version: '1.0.11', App: 'React Grid',
            Description: `Исправления главного меню (неверное позиционирование в некоторых случаях). В комбобоксе теперь выбранное значение показывается сверху списка, если это не мультивыбор.`,
            Date: '14/11/2025'
        },
        {
            Id: 12, Version: '1.0.12', App: 'React Grid',
            Description: ` 1. Активная закладка теперь показываются жирным цветом, а неактивная обычным.\n 2. Над сеткой пишется текущая сортировка.\n 3. В сущностях теперь работает сортировка по умолчанию.`,
            Date: '02/12/2025'
        },
        {
            Id: 13, Version: '1.0.13', App: 'MR',
            Description: ` Добавлены картинки навигации и кармана.`,
            Date: '03/12/2025'
        },
        {
            Id: 14, Version: '1.0.14', App: 'React Grid',
            Description: ` 1. При смене значения фильтра теперь номер закладки сбрасывается на первый.\n 2. При добавлении или копировании записи сетка теперь обновляется.`,
            Date: '05/12/2025'
        },
        {
            Id: 15, Version: '1.0.15', App: 'React Grid',
            Description: ` 1. Теперь ID-колонка идет последней по умолчанию.\n 2. Переделана логика редактирования в сетке.`,
            Date: '09/12/2025'
        },
        {
            Id: 16, Version: '1.0.16', App: 'React Grid',
        ...
        {
            Id: 18, Version: '1.0.18', App: 'React Grid',
            Description: ` 1. Исправлена ошибка блокирования перехода на строку после закрытия лукап-грида.\n 2. Обновлены все npm-пакеты до свежих версий.`,
            Date: '25/12/2025'
        },
    ];

    // Не забываем менять LastVersion !!!
    static LastVersion = 'v1.0.18';
