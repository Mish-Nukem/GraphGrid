        ...
        return (
            <>
                <div className="login-form" style={{ width: '400px' }}>
                    ...
                    <select
                        onChange={(e) => {
                            const serverType = e.target.selectedOptions.length > 0 && e.target.selectedOptions[0].value === 'ORACLE' ? 2 : 0;

                            GLObject.changeAPIurl(serverType);

                            loginForm.refreshState();
                        }}
                        value={GLObject.serverType === 2 ? "ORACLE" : "PostgreSQL"} //<option >PostgreSQL</option>
                    >
